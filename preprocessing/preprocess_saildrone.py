...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Convert downloaded Saildrone CSV files to the retained 10-minute sequences used by Wind-Mamba."
    )
    ...
    parser.add_argument("--skip-plot", action="store_true", help="Skip the missing-data diagnostic figure.")
...
def main():
    ...
    for input_name in INPUT_FILES:
        file_path = str((args.raw_dir / input_name).resolve())
    ...
    if merged_dfs and not args.skip_plot:
